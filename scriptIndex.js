...
function InitGridCanvas() {
	...
	var GridCanvas2D = GridCanvasEl.getContext( '2d' );
	  ...
	  GridGradient.addColorStop(0.000, 'rgb(0, 255, 127)'); // Verde neón claro
	  GridGradient.addColorStop(0.100, 'rgb(0, 200, 0)');   // Verde medio
	  GridGradient.addColorStop(0.300, 'rgb(50, 255, 50)'); // Verde claro
	  GridGradient.addColorStop(0.500, 'rgb(0, 150, 0)');   // Verde más oscuro
	  GridGradient.addColorStop(0.700, 'rgb(0, 255, 0)');   // Verde neón brillante
	  GridGradient.addColorStop(0.900, 'rgb(0, 180, 0)');   // Verde medio
	  GridGradient.addColorStop(1.000, 'rgb(0, 255, 127)'); // Verde neón claro
